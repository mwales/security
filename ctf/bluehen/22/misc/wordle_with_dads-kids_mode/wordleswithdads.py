...
def makeguess(guess, problem):
    ...
    if (problem["guesses"] >= 6):
        print("You lose")
        exit(1)
    #correct is an array of indices where your letters were perfect (correct letter correct position), position is an array of indices where your letter exists but is not in the right place
